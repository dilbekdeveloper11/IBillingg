        ...
        slivers: [
          ...
          SliverGrid(
              ...
              delegate: SliverChildBuilderDelegate((context, index) {
                return Widgets.Card(ntitle: "", height: height, width: width, colors: colors, opacity: opacity, smallTitle: smallTitle, smallTitleColor: smallTitleColor, ismi: ismi, amount: amount, lastInvoice: lastInvoice, number: number, date: date)
              })),
        ],
      ),
    );
